...
### `demand_signal` — 수요 신호 T1 · T2 (배치 산출)
<table fit-page-width="true" header-row="true">
<tr>
<td>컬럼</td>
<td>타입</td>
...
<td>`signal_type`</td>
<td>text</td>
<td>NOT NULL · CHECK `T1` `T2`</td>
<td>`T1` 최근 30일 신규 등록 · `T2` 행사 밀도 (FR-RU-110 – 122)</td>
</tr>
<tr color="red_bg">
<td>`region_key`</td>
<td>text</td>
...
<td>산출 대상 구간. T1 은 기준일 −30일, T2 는 그 상품의 여행일에서 나온다</td>
</tr>
<tr>
<td>`total_count`</td>
<td>int</td>
<td>NOT NULL · CHECK ≥ 0</td>
<td>구간 내 건수. **강도 점수를 담지 않는다** (FR-RU-121)</td>
</tr>
<tr>
<td>`by_type`</td>
<td>jsonb</td>
...
<td>구현의 `LlmPurpose`와 같다. 셋이 아니라 **둘**이다 (EI-LM-001)</td>
</tr>
<tr>
<td>`model`</td>
<td>text</td>
