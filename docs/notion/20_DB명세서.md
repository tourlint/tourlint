<callout icon="🗄" color="blue_bg">
	# TourLint DB 명세서
	**PostgreSQL 물리 스키마 정의서 — 테이블 18종 · 제약 · 인덱스 · 실행 가능한 DDL**
...
<td>text</td>
<td>NULL 허용</td>
<td>변경 전 지문. 재노출 판정 키</td>
</tr>
<tr>
<td>`change_hash_to`</td>
<td>text</td>
<td>NULL 허용</td>
<td>변경 후 지문. 동일 조합은 재노출 금지 (FR-MO-036)</td>
</tr>
<tr>
<td>`body`</td>
<td>jsonb</td>
...
<td>스트리밍 응답으로 즉시 내려보내고 파일을 남기지 않음. `report` 테이블에 PDF 바이너리를 넣는 설계 금지</td>
</tr>
<tr>
<td>캐시 계층</td>
