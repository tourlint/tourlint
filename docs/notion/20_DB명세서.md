...
<td>구간 내 건수. T3 는 관측된 방문자 수. **강도 점수 · 인기 점수를 담지 않는다** (FR-RU-121 · FR-MO-060)</td>
</tr>
<tr>
<td>`by_type`</td>
<td>jsonb</td>
