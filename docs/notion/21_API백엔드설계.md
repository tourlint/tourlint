...
POST /api/v1/products                추가 "planOrigin": { "startedBy": "MANUAL|UPLOAD|TEXT|CLONE|SIGNAL", "signal"?: { "type": "T2", "regnCd", "signguCd", "from", "to", "contentId"? } }
                                     days[].items[] 마다 "origin": "MANUAL|UPLOAD|TEXT|PICKER" (없거나 다른 값이면 MANUAL · PICKER 줄은 matched_by 를 비운다 · FR-PL-020), "excluded"?: true (직접 정한 곳 EXCLUDED · content 가 있으면 무시 · UI-S2-021)
